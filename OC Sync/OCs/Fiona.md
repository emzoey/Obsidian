fuck how do we organize this? whatever. started 1/2

## 1/2/26 

new idea: whenever someone is LOST, there is a "physical remnant" spot in unreality somewhere; essentially, where their physical body got "left behind". it's like unreality recognizes them as two separate beings now, so the body gets its OWN representation in unreality, just as an object would: a representation of all the perceptions, emotions, memories associated with that body. 
(wouldn't want to encourage the idea that their real body "dies" or whatever but bare with me here.)
fionas is ROTTING into the landscape, like a corpse melting and frozen during composition, think like its spreading a fungus that forms the environment around it. 


maybe theres only One fiona and youve been talking to figments of her?? that shes made of herself/? ?idk. 


--- 

fiona is to unreality as aradia is to dream bubbles :D
...
DUDE HOLY FREAKING AUSTIN ATLANTIS UM U FIGHT FIONA LIKE A FIGMENT WHEN SHE STARTS BREAKING APART. WHATEVER THA MEWNAS